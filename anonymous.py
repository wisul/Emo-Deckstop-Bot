...
async def start_group(_, message):
    ...
    fuk = "<b>ᴩᴏɴɢ ʙᴀʙʏ !</b>"
    await message.reply_photo(photo="https://telegra.ph/file/dd1f06997c722ce74d700.jpg", caption=fuk)
...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        if invitelink.startswith("https://t.me/Emo_Bot_Support"):
            invitelink = invitelink.replace(
                "https://t.me/+", "https://t.me/Emo_Bot_Support/"
            )
...
async def restart(_, message):
    ...
    if user_id != OWNER_ID:
        return
    await message.reply_text("» <i>ʀᴇsᴛᴀʀᴛɪɴɢ Emo Bot...</i>")
